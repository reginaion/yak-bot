...
1097790288904343635,1097790097916690433,1097791345709563947]
...
1099295924716589146,1099295976289751191,1099296010787901491]
...
async def on_raw_reaction_add(payload):
    ...
    if payload.guild_id in guild_list:
        ...
        if payload.message_id == svr.message_id['role_main']:
            ...
            if str(payload.emoji) != svr.emoji_jp and str(reaction.emoji) != svr.emoji_cn:
                return
